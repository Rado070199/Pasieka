...
<div class="container pt-5">
              <div class="row">
                    ...
                    <div class="row   mb-5">
                      <div class="col-12">
                        ...
                        <div class="dropdown float-right">
                          <a class="btn btn-lg btn-light dropdown-toggle products-count" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">5 <span class="caret"></span></a>
                    ...
                    <div class="row sorting mb-5 mt-5">
                      <div class="col-12">
                        ...
                        <div class="dropdown float-md-right">
                          <a class="btn btn-light btn-lg dropdown-toggle product-count" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">5 <span class="caret"></span></a>
                ...
                <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
                  ...
                  <a href="#" id="filter-button" class="btn btn-lg btn-block btn-primary mt-5">{{__('pasieka.welcome.filter')}}</a>
                  </div>
                </form>
              </div>
</x-app-layout>
