        ...
        <div class="container pt-5">
              <div class="row">
                <div class="col-md-8 order-md-2 col-lg-9">
                      ...
                      <div class="col-6 col-md-6 col-lg-4 mb-3">
                        <div class="card h-100 border-0">
                          ...
                          <div class="card-body text-center">
                            <h4 class="card-title">
                              <!-- <a href="products.show" class=" font-weight-bold text-dark text-uppercase small"></a> -->
                              {{$product->name}}
                            </h4>
                  ...
                  <a href="#" class="btn btn-lg btn-block btn-primary mt-5">{{__('pasieka.welcome.filter')}}</a>
                </div>
